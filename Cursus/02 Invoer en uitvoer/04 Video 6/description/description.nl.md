  ...
  <ul>
    ...
    <li> Enkele opmerkingen:
      <ul>
        ...
        <div align="center">
          <img src="media/keywords.png" style=”padding: 15px 0px 0px 0px” align="center" width="450px" data-caption="Een naam van een variabele mag geen gereserveerd woord zijn." />
        </div>
      </ul>
    </li>
  </ul>
